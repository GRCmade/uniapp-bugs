...
# 鸿蒙上previewImage传入的urls是响应式的不生效
...
<template>
	<view class="box">
		<view class="" v-for="(item,index) in list" :key="index">
			<image :src="item" mode="aspectFill" @click="click(index)"></image>
		</view>
	</view>
</template>
<script>
	export default {
		data() {
			return {
				title: 'index',
				list: ['https://yuhepicgo.oss-cn-beijing.aliyuncs.com/20250610144702277.png',
