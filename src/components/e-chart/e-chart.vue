  ...
  methods: {
    ...
    async initApp(option) {
      ...
      const { node, ctx, width, height, devicePixelRatio } = await this.getAppCanvas();
			console.log("node, ctx, width, height, devicePixelRatio",node, ctx, width, height, devicePixelRatio)
      ...
      this.echartObj = echarts.init(canvas, null, {
        ...
        height,
			...
			console.log("this.echartObj", typeof this.echartObj)
			console.log(this.echartObj._dom)
