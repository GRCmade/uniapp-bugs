    ...
    const controller = new CustomDialogController({
        builder: () => {
            let jsDialog = new Loading(this, {
                title: options.title || '',
            }, undefined, -1, () => { }, { page: "oh_modules/.ohpm/@dcloudio+uni-app-runtime@bbbgzu2+nym8rovvhvqvywy5i41gylhwcmcuqkuefss=/oh_modules/@dcloudio/uni-app-runtime/src/main/ets/uni-mp-sdk/components/ShowLoading.ets", line: 36, col: 14 });
