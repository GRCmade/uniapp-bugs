...
class CapsuleButton extends ViewPU {
    ...
    aboutToAppear() {
        font.registerFont({
            ...
            familySrc: { "id": 0, "type": 30000, params: ['uni-app/iconfont.ttf'], "bundleName": "com.example.test.template", "moduleName": "entry" }
        });
    }
    initialRender() {
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@dcloudio+uni-app-runtime@bbbgzu2+nym8rovvhvqvywy5i41gylhwcmcuqkuefss=/oh_modules/@dcloudio/uni-app-runtime/src/main/ets/uni-mp-sdk/components/Capsule.ets", line: 83, col: 7 });
            ...
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    CapsuleButton(this, {
                        ...
                        textColor: this.style.textColor,
                        highlightColor: this.style.highlightColor
                    }, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@dcloudio+uni-app-runtime@bbbgzu2+nym8rovvhvqvywy5i41gylhwcmcuqkuefss=/oh_modules/@dcloudio/uni-app-runtime/src/main/ets/uni-mp-sdk/components/Capsule.ets", line: 100, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            text: '\ue650',
