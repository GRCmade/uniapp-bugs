    ...
    }, __Common__);
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender, options = __options__) => {
            if (isInitialRender) {
                ...
                }, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@dcloudio+uni-app-runtime@bbbgzu2+nym8rovvhvqvywy5i41gylhwcmcuqkuefss=/oh_modules/@dcloudio/uni-app-runtime/src/main/ets/uni-mp-sdk/WebViewBuilder.ets", line: 17, col: 3 });
