...
function initControllerOnce(event: MultiSelectorPickerEvent): CustomDialogController {
    ...
    multiSelectorPickerDialogController = new CustomDialogController({
        builder: () => {
            ...
            }, undefined, -1, () => { }, { page: "oh_modules/.ohpm/@dcloudio+uni-app-runtime@bbbgzu2+nym8rovvhvqvywy5i41gylhwcmcuqkuefss=/oh_modules/@dcloudio/uni-app-runtime/src/main/ets/uni-mp-sdk/components/Picker.ets", line: 50, col: 14 });
