...
如果是运行到真机，请确认手机与电脑处于同一网络。`);
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "/Users/gaoruicheng/Downloads/deom-webview/pages/login/login.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        openUrl: ""
    ...
    onLoad() {
      this.openUrl = "http://218.245.63.50:9139/capital/goOutmanage/listmPage?catchID=adminyg";
    },
    methods: {}
  };
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "/Users/gaoruicheng/Downloads/deom-webview/pages/index/index.vue"]]);
