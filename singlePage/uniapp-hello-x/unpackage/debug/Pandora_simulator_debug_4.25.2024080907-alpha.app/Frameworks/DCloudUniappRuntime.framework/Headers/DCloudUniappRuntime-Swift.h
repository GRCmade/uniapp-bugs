...
SWIFT_CLASS("_TtC19DCloudUniappRuntime19CSSStyleDeclaration")
...
+ (id <UniObjectElement> _Nullable)getUniObjectElement:(NSString * _Nonnull)pageId :(NSString * _Nonnull)nodeId SWIFT_WARN_UNUSED_RESULT;
/// 释放uts创建的对象
/// \param obj uts创建的对象
///
...
///   </li>
/// </ul>
@property (nonatomic, readonly, strong) CSSStyleDeclaration * _Nonnull style;
/// <ul>
///   <li>
...
@protocol UniButtonElement <UniElement, JSExport>
/// <ul>
///   <li>
///     点击button
///   </li>
...
@property (nonatomic, strong) CSSStyleDeclaration * _Nonnull style;
...
/// uni extend
@property (nonatomic, strong) UniComponent * _Nullable currentEditComponent;
...
SWIFT_CLASS("_TtC19DCloudUniappRuntime20UniObjectCustomEvent")
@interface UniObjectCustomEvent : UniEvent
@end
...
/// @package io.dcloud.uniapp.runtime
/// @autodoc false
SWIFT_PROTOCOL("_TtP19DCloudUniappRuntime16UniObjectElement_")
@protocol UniObjectElement <UniElement>
/// 绑定iOS平台原生view
- (void)bindIOSView:(UIView * _Nonnull)view;
@end


SWIFT_CLASS("_TtC19DCloudUniappRuntime20UniObjectElementImpl")
@interface UniObjectElementImpl : UniElementImpl <UniObjectElement>
- (void)bindIOSView:(UIView * _Nonnull)view;
@end


SWIFT_CLASS("_TtC19DCloudUniappRuntime18UniObjectInitEvent")
@interface UniObjectInitEvent : UniEvent
@end
