...
@property (nonatomic, readonly, strong) NSDictionary<NSString *,id> *styles;
...
@property (atomic, assign) BOOL isCompositingChild;
...
@property (nonatomic, assign) BOOL uni_needUpdateZindex;
