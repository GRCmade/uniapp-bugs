...
typedef NSNumber* _Nonnull(^UniJsDocumentGetDurationCallback)(NSString *pageId, UniPageDurationType type);
...
setEnablePullDownRefresh:(UniJSPageStopSetEnablePullDownRefresh)setEnablePullDownRefreshCallback
          getPageStyle:(UniJsPageGetPageStyle)getPageStyleCallback
           getDuration:(UniJsDocumentGetDurationCallback)durationCallback;
