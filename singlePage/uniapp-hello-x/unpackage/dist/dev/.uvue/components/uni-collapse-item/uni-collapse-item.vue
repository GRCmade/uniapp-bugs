...
const _cache = this.$.renderCache
  return createElementVNode("view", utsMapOf({ class: "uni-collapse-item" }), [
    ...
    createElementVNode("view", utsMapOf({
      ref: "boxRef",
      class: "uni-collapse-item__content"
    }), [
      createElementVNode("view", utsMapOf({
        ref: "contentRef",
        class: "uni-collapse-item__content-box"
      }), [
...
const GenComponentsUniCollapseItemUniCollapseItemStyles = [utsMapOf([["uni-collapse-item", padStyleMapOf(utsMapOf([["backgroundColor", "#ffffff"]]))], ["uni-collapse-item__title", padStyleMapOf(utsMapOf([["flexDirection", "row"], ["alignItems", "center"], ["paddingTop", 12], ["paddingRight", 12], ["paddingBottom", 12], ["paddingLeft", 12], ["backgroundColor", "#ffffff"]]))], ["down_arrow", padStyleMapOf(utsMapOf([["width", 8], ["height", 8], ["transform", "rotate(45deg)"], ["borderRightWidth", 1], ["borderRightStyle", "solid"], ["borderRightColor", "#999999"], ["borderBottomWidth", 1], ["borderBottomStyle", "solid"], ["borderBottomColor", "#999999"], ["marginTop", -3], ["transitionProperty", "transform"], ["transitionDuration", "0.2s"]]))], ["down_arrow--active", padStyleMapOf(utsMapOf([["transform", "rotate(-135deg)"], ["marginTop", 0]]))], ["uni-collapse-item__title-text", padStyleMapOf(utsMapOf([["flex", 1], ["color", "#000000"], ["fontSize", 14], ["fontWeight", "400"]]))], ["open--active", padStyleMapOf(utsMapOf([["color", "#bbbbbb"]]))], ["is-disabled", padStyleMapOf(utsMapOf([["color", "#999999"]]))], ["uni-collapse-item__content", padStyleMapOf(utsMapOf([["display", "none"], ["position", "relative"]]))], ["uni-collapse-item__content-box", padStyleMapOf(utsMapOf([["width", "100%"], ["transitionProperty", "transform,opacity"], ["transitionDuration", "0.2s"], ["transform", "translateY(-100%)"], ["opacity", 0]]))], ["@TRANSITION", utsMapOf([["down_arrow", utsMapOf([["property", "transform"], ["duration", "0.2s"]])], ["uni-collapse-item__content-box", utsMapOf([["property", "transform,opacity"], ["duration", "0.2s"]])]])]])]

//# sourceMappingURL=uni-collapse-item.vue.map