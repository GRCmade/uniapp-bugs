...
function GenNodeModulesDcloudioUniComponentsLibXUnicloudDbUnicloudDbRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
const _cache = this.$.renderCache
  return createElementVNode("uni-cloud-db-element", utsMapOf({ ref: "UniCloudDB" }), [
...
//# sourceMappingURL=unicloud-db.vue.map