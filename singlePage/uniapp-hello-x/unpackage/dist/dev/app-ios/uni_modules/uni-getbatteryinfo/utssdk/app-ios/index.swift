...
@objcMembers
public class GetBatteryInfoSuccess : NSObject, UTSObject, IUTSSourceMap {
...
public class GetBatteryInfoOptions : NSObject, UTSObject, IUTSSourceMap {
    public func __$getOriginalPosition() -> UTSSourceMapPosition? {
        return UTSSourceMapPosition("GetBatteryInfoOptions", "uni_modules/uni-getbatteryinfo/utssdk/interface.uts", 34, 13);
    }
...
@objcMembers
public class GetBatteryInfoResult : NSObject, UTSObject, IUTSSourceMap {
    public func __$getOriginalPosition() -> UTSSourceMapPosition? {
        return UTSSourceMapPosition("GetBatteryInfoResult", "uni_modules/uni-getbatteryinfo/utssdk/interface.uts", 49, 13);
    }
    public var level: NSNumber!;
    public var isCharging: Bool = false;
    public subscript(_ key: String) -> Any? {
...
var res = GetBatteryInfoSuccess(UTSJSONObject([
    ...
    "level": Math.abs(NSNumber(UIDevice.current.batteryLevel * 100)),
