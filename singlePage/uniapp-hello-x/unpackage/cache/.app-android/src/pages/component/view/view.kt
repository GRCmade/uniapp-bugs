...
open class GenPagesComponentViewView : BasePage {
    ...
    open var start_time_enum: UTSArray<ItemType1> by `$data`;
    open var stay_time_enum: UTSArray<ItemType1> by `$data`;
    @Suppress("USELESS_CAST")
    override fun data(): Map<String, Any?> {
        return utsMapOf("hover_class" to false, "stop_propagation" to false, "start_time" to 50, "stay_time" to 400, "start_time_enum" to utsArrayOf<ItemType1>(ItemType1(value = 50, name = "50毫秒"), ItemType1(value = 200, name = "200毫秒")), "stay_time_enum" to utsArrayOf<ItemType1>(ItemType1(value = 400, name = "400毫秒"), ItemType1(value = 200, name = "200毫秒")));
    }
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("main" to padStyleMapOf(utsMapOf("paddingTop" to 5, "paddingRight" to 0, "paddingBottom" to 5, "paddingLeft" to 0, "flexDirection" to "row", "justifyContent" to "center")), "test-view" to padStyleMapOf(utsMapOf("height" to 200, "width" to 200, "backgroundColor" to "#FFFFFF")), "text" to padStyleMapOf(utsMapOf("color" to "#777777", "fontSize" to 13)), "is-hover" to padStyleMapOf(utsMapOf("backgroundColor" to "#179b16")), "is-parent-hover" to padStyleMapOf(utsMapOf("backgroundColor" to "#aa0000")));
            }
