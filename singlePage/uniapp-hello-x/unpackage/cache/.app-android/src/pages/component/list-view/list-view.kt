...
open class GenPagesComponentListViewListView : BasePage {
    ...
    open var size_enum: UTSArray<ItemType1> by `$data`;
    ...
    override fun `$initMethods`() {
        this.list_view_click = fun() {
            console.log("组件被点击时触发", " at pages/component/list-view/list-view.uvue:52");
        }
        ;
        this.list_view_touchstart = fun() {
            console.log("手指触摸动作开始", " at pages/component/list-view/list-view.uvue:53");
        }
        ;
        this.list_view_touchmove = fun() {
            console.log("手指触摸后移动", " at pages/component/list-view/list-view.uvue:54");
        }
        ;
        this.list_view_touchcancel = fun() {
            console.log("手指触摸动作被打断，如来电提醒，弹窗", " at pages/component/list-view/list-view.uvue:55");
        }
        ;
        this.list_view_touchend = fun() {
            console.log("手指触摸动作结束", " at pages/component/list-view/list-view.uvue:56");
        }
        ;
        this.list_view_tap = fun() {
            console.log("手指触摸后马上离开", " at pages/component/list-view/list-view.uvue:57");
        }
        ;
        this.list_view_longpress = fun() {
            console.log("如果一个组件被绑定了 longpress 事件，那么当用户长按这个组件时，该事件将会被触发。", " at pages/component/list-view/list-view.uvue:58");
        }
        ;
        this.list_view_refresherpulling = fun(e: RefresherEvent) {
            console.log("下拉刷新控件被下拉", " at pages/component/list-view/list-view.uvue:60");
            if (this.reset) {
                if (e.detail.dy > 45) {
                    this.state = 1;
                } else {
        ...
        this.list_view_refresherrefresh = fun() {
            console.log("下拉刷新被触发 ", " at pages/component/list-view/list-view.uvue:70");
        ...
        this.list_view_refresherrestore = fun() {
            ...
            this.state = 3;
            this.reset = true;
            console.log("下拉刷新被复位", " at pages/component/list-view/list-view.uvue:83");
        }
        ;
        this.list_view_refresherabort = fun() {
            console.log("下拉刷新被中止", " at pages/component/list-view/list-view.uvue:85");
        }
        ;
        this.list_view_scrolltoupper = fun(e: UniScrollToUpperEvent) {
            console.log("滚动到顶部/左边，会触发 scrolltoupper 事件  direction=" + e.detail.direction, " at pages/component/list-view/list-view.uvue:87");
        ...
        this.list_view_scrolltolower = fun(e: UniScrollToLowerEvent) {
            console.log("滚动到底部/右边，会触发 scrolltolower 事件  direction=" + e.detail.direction, " at pages/component/list-view/list-view.uvue:96");
        ...
        this.list_view_scroll = fun(e: UniScrollEvent) {
            console.log("滚动时触发，event.detail = {scrollLeft, scrollTop, scrollHeight, scrollWidth, deltaX, deltaY}", " at pages/component/list-view/list-view.uvue:105");
        ...
        this.list_view_scrollend = fun(e: UniScrollEvent) {
            console.log("滚动结束时触发", e.detail, " at pages/component/list-view/list-view.uvue:116");
        ...
        this.list_item_click = fun() {
            console.log("list-item组件被点击时触发", " at pages/component/list-view/list-view.uvue:126");
        }
        ;
        this.list_item_touchstart = fun() {
            console.log("手指触摸list-item组件动作开始", " at pages/component/list-view/list-view.uvue:127");
        }
        ;
        this.list_item_touchmove = fun() {
            console.log("手指触摸list-item组件后移动", " at pages/component/list-view/list-view.uvue:128");
        }
        ;
        this.list_item_touchcancel = fun() {
            console.log("手指触摸list-item组件动作被打断，如来电提醒，弹窗", " at pages/component/list-view/list-view.uvue:129");
        }
        ;
        this.list_item_touchend = fun() {
            console.log("手指触摸list-item组件动作结束", " at pages/component/list-view/list-view.uvue:130");
        }
        ;
        this.list_item_tap = fun() {
            console.log("手指触摸list-item组件后马上离开", " at pages/component/list-view/list-view.uvue:131");
        }
        ;
        this.list_item_longpress = fun() {
            console.log("list-item组件被绑定了 longpress 事件，那么当用户长按这个组件时，该事件将会被触发。", " at pages/component/list-view/list-view.uvue:132");
        }
        ;
        ...
        this.check_scroll_height = fun(): Boolean {
            ...
            console.log("check_scroll_height--" + listElement.scrollHeight, " at pages/component/list-view/list-view.uvue:182");
        ...
        this.check_scroll_width = fun(): Boolean {
            var listElement = this.`$refs`["listview"] as UniElement;
            console.log("check_scroll_width" + listElement.scrollWidth, " at pages/component/list-view/list-view.uvue:191");
