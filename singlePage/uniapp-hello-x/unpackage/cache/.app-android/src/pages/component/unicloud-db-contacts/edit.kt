...
open class GenPagesComponentUnicloudDbContactsEdit : BasePage {
                        ...
                        createVNode(_component_form, utsMapOf("key" to 2, "onSubmit" to _ctx.onFormSubmit), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return utsArrayOf(
                                ...
                                createElementVNode("view", utsMapOf("class" to "form-item"), utsArrayOf(
                                    ...
                                    createElementVNode("textarea", utsMapOf("class" to "form-item-input", "placeholder" to "备注", "name" to "comment", "maxlength" to "-1", "value" to data[0].getString("comment")), null, 8, utsArrayOf(
                                        "value"
                                    ))
                                )),
                                createElementVNode("view", utsMapOf("class" to "form-item"), utsArrayOf(
