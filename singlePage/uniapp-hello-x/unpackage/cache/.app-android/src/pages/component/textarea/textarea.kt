...
open class GenPagesComponentTextareaTextarea : BasePage {
    ...
    open var inputmode_enum: UTSArray<ItemType1> by `$data`;
    open var confirm_type_list: UTSArray<ItemType1> by `$data`;
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("adjust_position_boolean" to false, "show_confirm_bar_boolean" to false, "fixed_boolean" to false, "auto_height_boolean" to false, "confirm_hold_boolean" to false, "focus_boolean" to true, "auto_focus_boolean" to false, "default_value" to "1\n2\n3\n4\n5\n6", "inputmode_enum" to utsArrayOf<ItemType1>(ItemType1(value = 1, name = "text"), ItemType1(value = 2, name = "decimal"), ItemType1(value = 3, name = "numeric"), ItemType1(value = 4, name = "tel"), ItemType1(value = 5, name = "search"), ItemType1(value = 6, name = "email"), ItemType1(value = 7, name = "url"), ItemType1(value = 0, name = "none")), "confirm_type_list" to utsArrayOf<ItemType1>(ItemType1(value = 0, name = "return"), ItemType1(value = 1, name = "done"), ItemType1(value = 2, name = "send"), ItemType1(value = 3, name = "search"), ItemType1(value = 4, name = "next"), ItemType1(value = 5, name = "go")), "cursor_color" to "#3393E2", "cursor" to 0, "inputmode_enum_current" to 0, "confirm_type_current" to 0, "placeholder_value" to "请输入", "defaultModel" to "123", "textareaMaxLengthValue" to "", "selectionStart" to -1, "selectionEnd" to -1, "hold_keyboard" to false, "adjust_position" to false);
    }
    override fun `$initMethods`() {
        this.textarea_click = fun() {
            console.log("组件被点击时触发", " at pages/component/textarea/textarea.uvue:31");
        }
        ;
        this.textarea_touchstart = fun() {
            console.log("手指触摸动作开始", " at pages/component/textarea/textarea.uvue:32");
        }
        ;
        this.textarea_touchmove = fun() {
            console.log("手指触摸后移动", " at pages/component/textarea/textarea.uvue:33");
        }
        ;
        this.textarea_touchcancel = fun() {
            console.log("手指触摸动作被打断，如来电提醒，弹窗", " at pages/component/textarea/textarea.uvue:34");
        }
        ;
        this.textarea_touchend = fun() {
            console.log("手指触摸动作结束", " at pages/component/textarea/textarea.uvue:35");
        }
        ;
        this.textarea_tap = fun() {
            console.log("手指触摸后马上离开", " at pages/component/textarea/textarea.uvue:36");
        }
        ;
        this.textarea_longpress = fun() {
            console.log("如果一个组件被绑定了 longpress 事件，那么当用户长按这个组件时，该事件将会被触发。", " at pages/component/textarea/textarea.uvue:37");
        }
        ;
        this.textarea_confirm = fun() {
            console.log("点击完成时， 触发 confirm 事件，event.detail = {value: value}", " at pages/component/textarea/textarea.uvue:38");
        }
        ;
        this.textarea_input = fun() {
            console.log("当键盘输入时，触发 input 事件，event.detail = {value, cursor}， @input 处理函数的返回值并不会反映到 textarea 上", " at pages/component/textarea/textarea.uvue:39");
        }
        ;
        this.textarea_linechange = fun() {
            console.log("输入框行数变化时调用，event.detail = {height: 0, height: 0, lineCount: 0}", " at pages/component/textarea/textarea.uvue:40");
        }
        ;
        this.textarea_blur = fun() {
            console.log("输入框失去焦点时触发，event.detail = {value, cursor}", " at pages/component/textarea/textarea.uvue:41");
        }
        ;
        this.textarea_keyboardheightchange = fun() {
            console.log("键盘高度发生变化的时候触发此事件，event.detail = {height: height, duration: duration}", " at pages/component/textarea/textarea.uvue:42");
        }
        ;
        this.textarea_focus = fun() {
            console.log("输入框聚焦时触发，event.detail = { value, height }，height 为键盘高度", " at pages/component/textarea/textarea.uvue:43");
        }
        ;
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("main" to padStyleMapOf(utsMapOf("minHeight" to 100, "paddingTop" to 5, "paddingRight" to 0, "paddingBottom" to 5, "paddingLeft" to 0, "borderBottomWidth" to 1, "borderBottomStyle" to "solid", "borderBottomColor" to "rgba(0,0,0,0.06)", "flexDirection" to "row", "justifyContent" to "center")), "list-item" to utsMapOf(".main " to utsMapOf("width" to "100%", "height" to 100, "borderWidth" to 1, "borderStyle" to "solid", "borderColor" to "#666666")), "textarea-wrap" to padStyleMapOf(utsMapOf("flexDirection" to "row", "justifyContent" to "center")), "title-wrap" to padStyleMapOf(utsMapOf("flexDirection" to "row", "alignItems" to "center", "marginLeft" to 10)), "textarea-instance" to padStyleMapOf(utsMapOf("flex" to 1, "borderWidth" to 1, "borderStyle" to "solid", "borderColor" to "#666666", "marginTop" to 10, "marginRight" to 10, "marginBottom" to 10, "marginLeft" to 10)), "placeholder" to padStyleMapOf(utsMapOf("backgroundColor" to "#FFFF00")));
            }
