...
open class GenPagesComponentListViewListViewRefresh : BasePage {
    ...
    override fun `$initMethods`() {
        this.onRefresherrefresh = fun(e: UniRefresherEvent) {
            console.log("refresherrefresh-----下拉刷新被触发", e.detail.dy, " at pages/component/list-view/list-view-refresh.uvue:41");
        ...
        this.onRefresherabort = fun(e: UniRefresherEvent) {
            console.log("onRefresherabort------下拉刷新被中止", e.detail, " at pages/component/list-view/list-view-refresh.uvue:54");
        ...
        this.onRefresherrestore = fun(e: UniRefresherEvent) {
            console.log("onRefresherrestore------下拉刷新被复位", e.detail.dy, " at pages/component/list-view/list-view-refresh.uvue:63");
        ...
        this.onRefresherpulling = fun(e: UniRefresherEvent) {
            console.log("onRefresherpulling------拉刷新控件被下拉-dy=" + e.detail.dy, " at pages/component/list-view/list-view-refresh.uvue:72");
