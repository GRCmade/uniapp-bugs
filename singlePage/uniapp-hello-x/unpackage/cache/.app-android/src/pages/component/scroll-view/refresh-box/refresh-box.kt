...
open class GenPagesComponentScrollViewRefreshBoxRefreshBox : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("slot" to "refresher", "class" to "refresh-box"), utsArrayOf(
            if (_ctx.state == 2) {
                createElementVNode("image", utsMapOf("key" to 0, "class" to "refresh-icon", "src" to "/static/template/custom-refresher/refresh-box/run.gif", "mode" to "widthFix"));
            } else {
