...
open class GenPagesComponentSwiperSwiper : BasePage {
    ...
    override fun `$initMethods`() {
        this.swiperChange = fun(e: UniSwiperChangeEvent) {
            ...
            console.log(this.currentValChange, " at pages/component/swiper/swiper.uvue:137");
            if (this.swiperChangeSelect) {
                console.log("swiperChange", " at pages/component/swiper/swiper.uvue:139");
                console.log(e, " at pages/component/swiper/swiper.uvue:140");
            }
        }
        ;
        this.swiperTransition = fun(e: UniSwiperTransitionEvent) {
            ...
            if (this.swiperTransitionSelect) {
                console.log("swiperTransition", " at pages/component/swiper/swiper.uvue:151");
                console.log(e, " at pages/component/swiper/swiper.uvue:152");
            }
        }
        ;
        this.swiperAnimationfinish = fun(e: UniSwiperAnimationFinishEvent) {
            ...
            if (this.swiperAnimationfinishSelect) {
                console.log("swiperAnimationfinish", " at pages/component/swiper/swiper.uvue:163");
                console.log(e, " at pages/component/swiper/swiper.uvue:164");
            }
        }
        ;
        ...
        this.circularChange = fun(e: UniSwitchChangeEvent) {
            ...
            console.log(this.circularSelect, " at pages/component/swiper/swiper.uvue:225");
        }
        ;
        this.reboundSelectChange = fun(e: UniSwitchChangeEvent) {
            this.reboundSelect = e.detail.value;
            console.log(this.reboundSelect, " at pages/component/swiper/swiper.uvue:229");
        }
        ;
