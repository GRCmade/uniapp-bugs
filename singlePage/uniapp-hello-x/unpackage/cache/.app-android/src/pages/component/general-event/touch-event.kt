...
open class GenPagesComponentGeneralEventTouchEvent : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("scroll-view", utsMapOf("style" to normalizeStyle(utsMapOf("flex" to "1"))), utsArrayOf(
            createVNode(_component_page_head, utsMapOf("title" to "拖拽图标测试相关事件")),
            createElementVNode("view", utsMapOf("class" to "container"), utsArrayOf(
                createElementVNode("view", utsMapOf("class" to "view-box"), utsArrayOf(
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("move" to false, "posX" to 0, "posY" to 0, "lastX" to 0, "lastY" to 0, "touchEvent" to null as TouchEvent?, "icon" to null as UniElement?);
    }
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("container" to padStyleMapOf(utsMapOf("width" to "100%", "flexDirection" to "column", "alignItems" to "center")), "view-box" to padStyleMapOf(utsMapOf("width" to 300, "height" to 300, "alignItems" to "center", "justifyContent" to "center", "borderStyle" to "solid")), "icon" to padStyleMapOf(utsMapOf("width" to 100, "height" to 100)), "msg-text" to padStyleMapOf(utsMapOf("marginBottom" to 100)), "title1" to padStyleMapOf(utsMapOf("marginTop" to 10, "fontSize" to 18)), "title2" to padStyleMapOf(utsMapOf("marginTop" to 5, "fontSize" to 16)));
            }
