...
open class GenPagesComponentScrollViewScrollViewCustomRefresherProps : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("scroll-view", utsMapOf("style" to normalizeStyle(utsMapOf("flex" to "1")), "refresher-enabled" to true, "refresher-triggered" to _ctx.refresherTriggered, "refresher-default-style" to "none", "onRefresherpulling" to _ctx.onRefresherpulling, "onRefresherrefresh" to _ctx.onRefresherrefresh, "onRefresherrestore" to _ctx.onRefreshrestore, "refresher-max-drag-distance" to "200px"), utsArrayOf(
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("refresherTriggered" to false, "pullingDistance" to 0, "resetting" to false, "state" to computed<Number>(fun(): Number {
            if (this.resetting) {
                return 3;
            }
