...
open class GenPagesComponentMixinDatacomDatacom : VueComponent {
    ...
    override fun `$initMethods`() {
        ...
        this.onMixinDatacomPropsChange = fun(needReset: Boolean, changed: UTSArray<String>) {
            console.log(needReset, changed, " at pages/component/mixin-datacom/datacom.uvue:51");
        }
        ;
    }
