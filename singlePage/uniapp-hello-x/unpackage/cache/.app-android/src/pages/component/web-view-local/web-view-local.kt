...
open class GenPagesComponentWebViewLocalWebViewLocal : BasePage {
    ...
    override fun `$initMethods`() {
        this.message = fun(event: UniWebViewMessageEvent) {
            console.log(JSON.stringify(event.detail), " at pages/component/web-view-local/web-view-local.uvue:21");
        ...
        this.error = fun(event: UniWebViewErrorEvent) {
            this.loadError = true;
            console.log(JSON.stringify(event.detail), " at pages/component/web-view-local/web-view-local.uvue:40");
        }
        ;
        this.loading = fun(event: UniWebViewLoadingEvent) {
            console.log(JSON.stringify(event.detail), " at pages/component/web-view-local/web-view-local.uvue:43");
        }
        ;
        this.load = fun(event: UniWebViewLoadEvent) {
            this.loadFinish = true;
            console.log(JSON.stringify(event.detail), " at pages/component/web-view-local/web-view-local.uvue:47");
        }
        ;
