...
open class GenPagesComponentUnicloudDbContactsAdd : BasePage {
            ...
            createVNode(_component_form, utsMapOf("onSubmit" to _ctx.onFormSubmit), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                return utsArrayOf(
                    ...
                    createElementVNode("view", utsMapOf("class" to "form-item"), utsArrayOf(
                        ...
                        createElementVNode("textarea", utsMapOf("class" to "form-item-input", "placeholder" to "备注", "name" to "comment", "maxlength" to "-1"))
                    )),
                    createElementVNode("view", utsMapOf("class" to "form-item"), utsArrayOf(
    ...
    override fun `$initMethods`() {
        this.onFormSubmit = fun(e: UniFormSubmitEvent) {
            ...
            ;
            console.log("formData", formData, " at pages/component/unicloud-db-contacts/add.uvue:54");
