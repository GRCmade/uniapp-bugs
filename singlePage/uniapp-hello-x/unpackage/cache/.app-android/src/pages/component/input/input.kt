...
open class GenPagesComponentInputInput : BasePage {
            ...
            createElementVNode("view", utsMapOf("class" to "uni-common-mt uni-padding-wrap"), utsArrayOf(
                ...
                createElementVNode("view", null, utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "uni-title", "onClick" to fun(){
                        ...
                        createElementVNode("text", utsMapOf("class" to "uni-title-text"), "设置输入框聚焦时光标的位置（点击生效）")
                    ), 8, utsArrayOf(
                        "onClick"
                    )),
                    createElementVNode("view", utsMapOf("class" to "input-wrapper"), utsArrayOf(
                        createElementVNode("input", utsMapOf("ref" to "input", "class" to "uni-input", "value" to "0123456789", "cursor" to _ctx.cursor, "onBlur" to _ctx.onCursorBlurChange), null, 40, utsArrayOf(
                            "cursor",
                            "onBlur"
                        ))
                    ))
                ...
                createElementVNode("view", null, utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "uni-title", "onClick" to fun(){
                        ...
                        createElementVNode("text", utsMapOf("class" to "uni-title-text"), "设置输入框聚焦时光标的起始位置和结束位置（点击生效）")
                    ), 8, utsArrayOf(
                        "onClick"
                    )),
                    createElementVNode("view", utsMapOf("class" to "input-wrapper"), utsArrayOf(
                        createElementVNode("input", utsMapOf("ref" to "input2", "class" to "uni-input", "value" to "0123456789", "selection-start" to _ctx.selectionStart, "selection-end" to _ctx.selectionEnd, "onBlur" to _ctx.onSelectionBlurChange), null, 40, utsArrayOf(
                            "selection-start",
                            "selection-end",
                            "onBlur"
                        ))
                ...
                createElementVNode("view", null, utsArrayOf(
                    ...
                    createElementVNode("view", utsMapOf("class" to "input-wrapper"), utsArrayOf(
                        createElementVNode("input", utsMapOf("id" to "uni-input-cursor-color", "class" to "uni-input", "cursor-color" to _ctx.cursor_color, "value" to "光标颜色"), null, 8, utsArrayOf(
                            "cursor-color"
                        ))
                    ))
                )),
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("title" to "input", "showClearIcon" to false, "inputClearValue" to "", "showPassword" to true, "cursor" to -1, "cursor_color" to "#3393E2", "selectionStart" to -1, "selectionEnd" to -1, "inputEventDetail" to "", "focusAndBlurEventDetail" to "", "confirmEventDetail" to "", "keyboardHeightChangeEventDetail" to "", "focus" to true, "inputPassword" to true, "inputTypeTel" to "tel", "inputPlaceHolderStyle" to "color:red", "inputPlaceHolderClass" to "uni-input-placeholder-class" as String, "inputMaxLengthValue" to "", "onMaxLengthInputValue" to "", "inputMaxLengthFocus" to false, "inputPasswordValue" to "cipher", "inputFocusKeyBoardChangeValue" to true, "holdKeyboard" to false, "keyboardHeight" to 0, "focusedForKeyboardHeightChangeTest" to false, "demoValue" to "123", "adjustPosition" to false);
    }
    override fun `$initMethods`() {
        ...
        this.onInput = fun(event: UniInputEvent) {
            console.log("键盘输入", JSON.stringify(event.detail), " at pages/component/input/input.uvue:338");
            this.inputEventDetail = JSON.stringify(event.detail);
        }
        ;
        this.onFocus = fun(event: UniInputFocusEvent) {
            console.log("输入框聚焦", JSON.stringify(event.detail), " at pages/component/input/input.uvue:342");
            this.focusAndBlurEventDetail = JSON.stringify(event.detail);
        }
        ;
        this.onBlur = fun(event: UniInputBlurEvent) {
            console.log("输入框失去焦点", JSON.stringify(event.detail), " at pages/component/input/input.uvue:346");
            this.focusAndBlurEventDetail = JSON.stringify(event.detail);
        }
        ;
        this.onConfirm = fun(event: UniInputConfirmEvent) {
            console.log("点击完成按钮", JSON.stringify(event.detail), " at pages/component/input/input.uvue:350");
        ...
        this.onKeyborardHeightChange = fun(event: UniInputKeyboardHeightChangeEvent) {
            console.log("键盘高度发生变化", JSON.stringify(event.detail), " at pages/component/input/input.uvue:354");
        ...
        this.changeCursorColor = fun(event: UniSwitchChangeEvent) {
            ...
            val input = uni_getElementById<UniInputElement>("uni-input-cursor-color");
            input?.focus();
        }
        ;
