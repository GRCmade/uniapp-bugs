...
open class GenPagesComponentGeneralEventTransitionEvent : BasePage {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {
        onReady(fun() {
            var that = this;
            open class ThreadRunnable : Runnable, IUTSSourceMap {
                override fun `__$getOriginalPosition`(): UTSSourceMapPosition {
                    return UTSSourceMapPosition("ThreadRunnable", "pages/component/general-event/transition-event.uvue", 34, 13);
                }
                override fun run() {
                    that.isShow = true;
                }
