...
open class GenPagesComponentStickyHeaderStickyHeader : BasePage {
    ...
    override fun `$initMethods`() {
        this.list_view_refresherrefresh = fun() {
            console.log("下拉刷新被触发 ", " at pages/component/sticky-header/sticky-header.uvue:53");
        ...
        this.clickTH = fun(index: Number) {
            console.log("点击表头：" + index, " at pages/component/sticky-header/sticky-header.uvue:63");
        }
        ;
    }
