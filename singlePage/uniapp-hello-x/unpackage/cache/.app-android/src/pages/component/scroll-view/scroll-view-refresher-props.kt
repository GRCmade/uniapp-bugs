...
open class GenPagesComponentScrollViewScrollViewRefresherProps : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("class" to "page-scroll-view"), utsArrayOf(
            ...
            createElementVNode("scroll-view", utsMapOf("class" to "uni-list", "showScrollbar" to true), utsArrayOf(
    ...
    override fun `$initMethods`() {
        ...
        this.refresherpulling = fun() {
            console.log("下拉刷新控件被下拉", " at pages/component/scroll-view/scroll-view-refresher-props.uvue:105");
        }
        ;
        this.refresherrefresh = fun() {
            console.log("下拉刷新被触发", " at pages/component/scroll-view/scroll-view-refresher-props.uvue:108");
        ...
        this.refresherrestore = fun() {
            console.log("下拉刷新被复位", " at pages/component/scroll-view/scroll-view-refresher-props.uvue:116");
        }
        ;
        this.refresherabort = fun() {
            console.log("下拉刷新被中止", " at pages/component/scroll-view/scroll-view-refresher-props.uvue:119");
        }
        ;
    }
