...
open class GenPagesTemplateNavbarLiteNavbarLite : BasePage {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {
        onReady(fun() {
            ...
            this.inputRemainHeight = windowHeight - (uni_getElementById("input")?.getBoundingClientRect()?.bottom ?: windowHeight);
        }
        , __ins);
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("class" to "content"), utsArrayOf(
            ...
            if (_ctx.indexView == 0) {
                createElementVNode("scroll-view", utsMapOf("key" to 0, "class" to "scroll-view"), utsArrayOf(
    ...
    override fun `$initMethods`() {
        ...
        this.setNavigationBarColor1 = fun() {
            uni_setNavigationBarColor(SetNavigationBarColorOptions(frontColor = "#ffffff", backgroundColor = "#0000", success = fun(_){
                ...
                console.log("setNavigationBarColor success", " at pages/template/navbar-lite/navbar-lite.uvue:70");
                this.setLifeCycleNum(state.lifeCycleNum + 1);
            }
            , fail = fun(_){
                console.log("setNavigationBarColor fail", " at pages/template/navbar-lite/navbar-lite.uvue:74");
                this.setLifeCycleNum(state.lifeCycleNum - 1);
            }
            , complete = fun(_){
                console.log("setNavigationBarColor complete", " at pages/template/navbar-lite/navbar-lite.uvue:78");
                this.setLifeCycleNum(state.lifeCycleNum + 1);
            }
            ));
        }
        ...
        this.setNavigationBarColor2 = fun() {
            uni_setNavigationBarColor(SetNavigationBarColorOptions(frontColor = "#000000", backgroundColor = "#0000", success = fun(_){
                ...
                console.log("setNavigationBarColor success", " at pages/template/navbar-lite/navbar-lite.uvue:89");
                this.setLifeCycleNum(state.lifeCycleNum + 1);
            }
            , fail = fun(_){
                console.log("setNavigationBarColor fail", " at pages/template/navbar-lite/navbar-lite.uvue:93");
                this.setLifeCycleNum(state.lifeCycleNum - 1);
            }
            , complete = fun(_){
                console.log("setNavigationBarColor complete", " at pages/template/navbar-lite/navbar-lite.uvue:97");
                this.setLifeCycleNum(state.lifeCycleNum + 1);
            }
            ));
        }
