...
open class GenPagesTemplateDropCardCardCard : VueComponent {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {
        onMounted(fun() {
            uni_getSystemInfo(GetSystemInfoOptions(success = fun(e){
        ...
        this.touchend = fun() {
            ...
            if (Math.floor(k) != 0) {
                ...
                cardTo(Math.floor(_x * -0.05), Math.floor(_y * -0.05), fun(){
                    cardTo(0, 0, fun(){
                        console.log("bounce", " at pages/template/drop-card/card/card.uvue:187");
                        floating = false;
                    }
                    , 30);
                }
    ...
    companion object {
        ...
        var props = normalizePropsOptions(utsMapOf("img" to utsMapOf("type" to "String", "default" to "/static/template/drop-card/1.jpg"), "cardIndex" to utsMapOf("type" to "Number", "default" to 0)));
