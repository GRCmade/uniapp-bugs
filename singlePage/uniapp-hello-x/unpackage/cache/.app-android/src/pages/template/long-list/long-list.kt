...
open class GenPagesTemplateLongListLongList : BasePage {
    ...
    override fun `$initMethods`() {
        ...
        this.onSwiperAnimationfinish = fun(e: SwiperAnimationFinishEvent) {
            ...
            console.log("this.animationFinishIndex", e.detail.current, " at pages/template/long-list/long-list.uvue:173");
        }
        ;
        this.cacheTabItemsSize = fun() {
            ...
            tabs.forEach(fun(node){
                this.swiperTabsRect.push(SwiperTabsItem2(x = node.offsetLeft, w = node.offsetWidth));
            }
            );
        }
        ;
