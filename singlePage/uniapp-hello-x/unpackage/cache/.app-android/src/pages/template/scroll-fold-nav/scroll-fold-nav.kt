...
open class GenPagesTemplateScrollFoldNavScrollFoldNav : BasePage {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {
        ...
        onReady(fun() {
            ...
            var seatElement = this.`$refs`["seatbar"] as UniElement;
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("statusBarHeight" to 0, "nviBarHeight" to 0, "naviElement" to null as UniElement?, "titleElement" to null as UniElement?, "searchElement" to null as UniElement?);
    }
