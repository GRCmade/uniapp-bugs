...
open class GenPagesTemplateHalfScreenHalfScreen : BasePage {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {
        onReady(fun() {
            ...
            this.totalHeight = uni_getElementById("page")?.getBoundingClientRect()?.height ?: 0;
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("id" to "page", "class" to "page"), utsArrayOf(
    ...
    override fun `$initMethods`() {
        ...
        this.switchHalfScreen = fun(show: Boolean) {
            if (show && ("visible" == this.halfNode?.style?.getPropertyValue("visibility"))) {
                console.log("quick click button!!!", " at pages/template/half-screen/half-screen.uvue:105");
                return;
            }
            this.halfMove = false;
            this.scrollNode?.setAttribute("direction", "vertical");
