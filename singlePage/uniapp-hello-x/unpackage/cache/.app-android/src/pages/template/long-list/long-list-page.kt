...
open class GenPagesTemplateLongListLongListPage : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        , "associative-container" to "nested-scroll-view"), utsArrayOf(
            createElementVNode(Fragment, null, RenderHelpers.renderList(_ctx.dataList, fun(item, _, __index, _cached): Any {
                return createElementVNode("list-item", utsMapOf("class" to "list-item", "key" to item.plugin_id), utsArrayOf(
    ...
    open var dataList: UTSArray<ListItem5> by `$data`;
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("loading" to false, "dataList" to utsArrayOf<ListItem5>(), "isEnded" to false, "loadingError" to "", "currentPage" to 1, "loadingText" to computed<String>(fun(): String {
            if (this.loading) {
                return "加载中...";
