...
open class GenPagesAPIGetSystemInfoGetSystemInfo : BasePage {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("title" to "getSystemInfo", "items" to utsArrayOf<Item2>());
    }
    override fun `$initMethods`() {
        this.getSystemInfo = fun() {
            uni_getSystemInfo(GetSystemInfoOptions(success = fun(res){
                ...
                val res_obj = UTSAndroid.consoleDebugError(JSON.parseObject(res_str), " at pages/API/get-system-info/get-system-info.uvue:56");
        ...
        this.getSystemInfoSync = fun() {
            ...
            val res_str = JSON.stringify(res);
            val res_obj = UTSAndroid.consoleDebugError(JSON.parseObject(res_str), " at pages/API/get-system-info/get-system-info.uvue:79");
            val res_map = res_obj!!.toMap();
            var keys = utsArrayOf<String>();
            res_map.forEach(fun(_, key){
                keys.push(key);
