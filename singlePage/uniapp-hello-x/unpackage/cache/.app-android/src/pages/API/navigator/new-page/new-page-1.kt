    ...
    override fun `$initMethods`() {
        ...
        this.navigateBackWithDelta2 = fun() {
            uni_navigateBack(NavigateBackOptions(delta = 2, success = fun(_) {
                console.log("回退上上层页面成功", " at pages/API/navigator/new-page/new-page-1.uvue:35");
            }
            , fail = fun(error) {
                console.warn("\u56DE\u9000\u4E0A\u4E0A\u5C42\u9875\u9762\u5931\u8D25: " + error.errMsg, " at pages/API/navigator/new-page/new-page-1.uvue:38");
            }
            ));
        }
        ;
