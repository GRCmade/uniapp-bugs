...
open class GenPagesAPINavigatorNavigator : BasePage {
    ...
    override fun `$initMethods`() {
        this.reLaunch = fun() {
            uni_reLaunch(ReLaunchOptions(url = "/pages/tabBar/component", success = fun(result) {
                ...
                uni.UNI174BAC2.setLifeCycleNum(state.lifeCycleNum + 1);
            }
            , fail = fun(error) {
        ...
        ;
        this.navigateToAnimationType = fun(animationType: String) {
    ...
    open lateinit var navigateToAnimationType: (animationType: String) -> Unit;
