...
open class GenPagesAPIGetCurrentPagesSetPageStyleDisablePullDownRefresh : BasePage {
    ...
    open var pages: UTSArray<Page3> by `$data`;
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("checked" to false, "pages" to utsArrayOf<Page3>(), "currentPageStyle" to UTSJSONObject(), "enablePullDownRefreshStatus" to true, "pageStyleText" to computed<String>(fun(): String {
