...
open class GenPagesAPILoadingLoading : BasePage {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("title" to "loading", "items" to utsArrayOf<ItemType6>(ItemType6(value = "null", name = "无标题"), ItemType6(value = "三秒后自动关闭", name = "普通标题"), ItemType6(value = "超长文本内容，测试超出范围-超长文本内容，测试超出范围-三秒后自动关闭", name = "长标题")), "current" to 0, "maskSelect" to false, "titleSelect" to "null");
    }
