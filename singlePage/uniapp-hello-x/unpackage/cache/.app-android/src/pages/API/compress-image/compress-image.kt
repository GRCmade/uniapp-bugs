...
open class GenPagesAPICompressImageCompressImage : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("scroll-view", utsMapOf("style" to normalizeStyle(utsMapOf("flex" to "1"))), utsArrayOf(
            ...
            createVNode(_component_input_data, utsMapOf("defaultValue" to "auto", "title" to "压缩后图片的宽度，支持px、%、auto", "type" to "string", "onConfirm" to _ctx.onWidthConfirm), null, 8, utsArrayOf(
                "onConfirm"
            )),
            createVNode(_component_input_data, utsMapOf("defaultValue" to "auto", "title" to "压缩后图片的高度，支持px、%、auto", "type" to "string", "onConfirm" to _ctx.onHeightConfirm), null, 8, utsArrayOf(
                "onConfirm"
            )),
    ...
    open var height: String by `$data`;
    open var rotate: Number by `$data`;
    open var imageInfoForTest: Any? by `$data`;
    open var imageSrcForTest: String by `$data`;
    @Suppress("USELESS_CAST")
    override fun data(): Map<String, Any?> {
        return utsMapOf("title" to "compressImage", "beforeCompressImageInfo" to "", "afterCompressImageInfo" to "", "beforeCompressPath" to "", "afterCompressPath" to "", "quality" to 80, "compressedWidth" to null as Number?, "compressedHeight" to null as Number?, "width" to "auto", "height" to "auto", "rotate" to 0, "imageInfoForTest" to null, "imageSrcForTest" to "/static/test-image/logo.png");
    }
    override fun `$initMethods`() {
        this.compressImage = fun() {
            ...
            uni_compressImage(CompressImageOptions(src = this.beforeCompressPath, quality = this.quality, compressedWidth = this.compressedWidth, compressedHeight = this.compressedHeight, width = this.width, height = this.height, rotate = this.rotate, success = fun(res){
                console.log("compressImage success", JSON.stringify(res), " at pages/API/compress-image/compress-image.uvue:82");
        ...
        ;
        this.onWidthConfirm = fun(value: String) {
            this.width = value;
        }
        ;
        this.onHeightConfirm = fun(value: String) {
            this.height = value;
        }
        ;
    ...
    open lateinit var onWidthConfirm: (value: String) -> Unit;
    open lateinit var onHeightConfirm: (value: String) -> Unit;
