    ...
    override fun `$initMethods`() {
        ...
        this.setAppTheme = fun(value: String) {
            uni_setAppTheme(SetAppThemeOptions(theme = value, success = fun(_) {
                console.log("设置appTheme为", value, "成功", " at pages/API/theme-change/theme-change.uvue:72");
            }
            , fail = fun(e: IAppThemeFail) {
                console.log("设置appTheme为", value, "失败,原因:", e.errMsg, " at pages/API/theme-change/theme-change.uvue:75");
            }
            ));
        }
        ;
