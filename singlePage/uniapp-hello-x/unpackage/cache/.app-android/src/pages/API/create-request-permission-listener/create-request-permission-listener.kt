    ...
    override fun `$initMethods`() {
        ...
        this.requestPermission = fun() {
            ...
            UTSAndroid.requestSystemPermission(UTSAndroid.getUniActivity()!!, utsArrayOf(
                ...
                console.log(p, " at pages/API/create-request-permission-listener/create-request-permission-listener.uvue:61");
            }
            , fun(_: Boolean, p: UTSArray<String>){
                uni_showToast(ShowToastOptions(title = "权限被拒绝了", position = "bottom"));
                console.log(p, " at pages/API/create-request-permission-listener/create-request-permission-listener.uvue:67");
            }
            );
        }
        ;
