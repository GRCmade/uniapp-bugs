    ...
    override fun `$initMethods`() {
        this.chooseImage = fun() {
            uni_chooseImage(ChooseImageOptions(count = 1, sizeType = utsArrayOf(
                ...
                , fail = fun(err){
                    console.log("uploadImage fail", err, " at pages/API/upload-file/upload-file.uvue:73");
                    uni_hideLoading();
            ...
            , fail = fun(err){
                console.log("chooseImage fail", err, " at pages/API/upload-file/upload-file.uvue:83");
            }
            ));
        }
        ;
        ...
        this.jest_uploadFile_with_uni_env = fun() {
            val filePath = "" + uni_env.CACHE_PATH + "/download/uni-app.png";
        ...
        this.jest_cookie_upload = fun(needCookie: Boolean) {
            val imageSrc = "/static/uni.png";
            this.task = uni_uploadFile(UploadFileOptions(url = "https://request.dcloud.net.cn/api/http/header/upload", filePath = imageSrc, name = "file", success = fun(res: UploadFileSuccess){
                val data = UTSAndroid.consoleDebugError(JSON.parseObject(res.data), " at pages/API/upload-file/upload-file.uvue:168");
        ...
        this.jest_files_upload = fun() {
            val imageSrc = "/static/uni.png";
            this.task = uni_uploadFile(UploadFileOptions(url = "https://unidemo.dcloud.net.cn/upload", files = utsArrayOf(
        ...
        this.jest_uts_module_invoked = fun() {
            testInovkeUploadFile(CommonOptions(success = fun(res: Any){
                console.log("success :", res, " at pages/API/upload-file/upload-file.uvue:209");
                this.jest_result = true;
            }
            , fail = fun(err: Any){
                console.log("fail :", err, " at pages/API/upload-file/upload-file.uvue:213");
                this.jest_result = false;
            }
            ));
        }
