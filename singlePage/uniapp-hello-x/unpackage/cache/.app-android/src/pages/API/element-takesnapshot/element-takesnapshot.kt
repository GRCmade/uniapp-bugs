    ...
    override fun `$initMethods`() {
        this.takeSnapshotClick = fun() {
            ...
            view.takeSnapshot(TakeSnapshotOptions(success = fun(res){
                console.log(res.tempFilePath, " at pages/API/element-takesnapshot/element-takesnapshot.uvue:27");
                this.snapImage = res.tempFilePath;
                this.mode = "widthFix";
                uni_showToast(ShowToastOptions(title = "截图成功，路径：" + res.tempFilePath, icon = "none"));
            }
            , fail = fun(res){
                console.log(res, " at pages/API/element-takesnapshot/element-takesnapshot.uvue:36");
