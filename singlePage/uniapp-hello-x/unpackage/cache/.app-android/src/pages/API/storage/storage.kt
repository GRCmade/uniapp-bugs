...
open class GenPagesAPIStorageStorage : BasePage {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("title" to "get/set/clearStorage", "key" to "", "data" to "" as Any, "apiGetData" to "" as Any?, "storageInfo" to "");
    }
    override fun `$initMethods`() {
        ...
        this.getStorageInfoSync = fun() {
            try {
                ...
                console.log(e, " at pages/API/storage/storage.uvue:127");
            }
        }
        ;
        ...
        this.complexMock = fun() {
            this.key = "key_" + Math.random();
            var jsonObj = object : UTSJSONObject(UTSSourceMapPosition("jsonObj", "pages/API/storage/storage.uvue", 157, 13)) {
                var name = "张三"
                var age: Number = 12
