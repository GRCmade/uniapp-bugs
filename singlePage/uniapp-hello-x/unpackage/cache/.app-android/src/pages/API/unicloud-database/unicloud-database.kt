...
open class GenPagesAPIUnicloudDatabaseUnicloudDatabase : BasePage {
    ...
    override fun `$initMethods`() {
        this.notify = fun(content: String, title: String) {
            if (!this.isUniTest) {
                ...
                console.log(title, content, " at pages/API/unicloud-database/unicloud-database.uvue:57");
            }
        }
        ;
        this.dbAdd = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection("type").add(let {
                    ...
                    uni_hideLoading();
                    console.log(res, " at pages/API/unicloud-database/unicloud-database.uvue:73");
                    this.addId = res.id;
        ...
        this.dbBatchAdd = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection("type").add(utsArrayOf(
                    ...
                    uni_hideLoading();
                    console.log(res, " at pages/API/unicloud-database/unicloud-database.uvue:98");
                    console.log("JSON.stringify(res.inserted)", JSON.stringify(res.inserted), " at pages/API/unicloud-database/unicloud-database.uvue:99");
        ...
        this.dbGet = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection("type").where("tag == \"" + this.dataTag + "\"").field("num, tag").orderBy("num desc").skip(1).limit(2).get().then(fun(res){
                    uni_hideLoading();
                    console.log(res, " at pages/API/unicloud-database/unicloud-database.uvue:126");
        ...
        this.dbGetWithCommand = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection("type").where(let {
                    ...
                    uni_hideLoading();
                    console.log(res, " at pages/API/unicloud-database/unicloud-database.uvue:153");
        ...
        this.dbUpdate = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection("type").where("tag == \"" + this.dataTag + "\"").update(object : UTSJSONObject() {
                    ...
                    uni_hideLoading();
                    console.log(res, " at pages/API/unicloud-database/unicloud-database.uvue:177");
        ...
        this.dbRemove = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection("type").where("tag == \"" + this.dataTag + "\"").remove().then(fun(res){
                    uni_hideLoading();
                    console.log(res, " at pages/API/unicloud-database/unicloud-database.uvue:199");
        ...
        this.dbLookupInit = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection("local").where("tag == \"" + this.dataTag + "\"").remove().then(fun(): UTSPromise<UniCloudDBRemoveResult> {
                    ...
                    uni_hideLoading();
                    console.error(err, " at pages/API/unicloud-database/unicloud-database.uvue:254");
                    val error = err as UniCloudError;
                    this.notify(error.errMsg, "错误");
                }
                ));
        ...
        this.dbLookup = fun(): UTSPromise<Unit> {
            suspend fun async(): Unit {
                ...
                await(db.collection(local, foreign).get().then(fun(res){
                    uni_hideLoading();
                    console.log(res, " at pages/API/unicloud-database/unicloud-database.uvue:274");
                ...
                await(db.multiSend(temp1, temp2).then<Unit>(fun(res){
                    ...
                    run {
                        ...
                        while(i < res.dataList.length){
                            ...
                            if (item.errCode == 0) {
                                console.log("\u7B2C" + i + "\u4E2A\u8BF7\u6C42\u67E5\u8BE2\u5230" + item.data!!.length + "\u6761\u6570\u636E", " at pages/API/unicloud-database/unicloud-database.uvue:301");
                                successCount++;
                            } else {
                                console.error("\u7B2C" + i + "\u4E2A\u8BF7\u6C42\u67E5\u8BE2\u5931\u8D25\uFF0C\u9519\u8BEF\u4FE1\u606F\uFF1A" + item.data!!.length, " at pages/API/unicloud-database/unicloud-database.uvue:304");
                            }
                            i++;
                        }
                    }
                    ...
                    uni_hideLoading();
                    val error = err as UniCloudError;
                    console.error(err, " at pages/API/unicloud-database/unicloud-database.uvue:313");
                    this.notify(error.errMsg, "错误");
                }
                ));
            }
