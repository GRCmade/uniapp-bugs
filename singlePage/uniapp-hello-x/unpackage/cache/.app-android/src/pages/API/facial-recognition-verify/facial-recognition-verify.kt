...
open class GenPagesAPIFacialRecognitionVerifyFacialRecognitionVerify : BasePage {
    ...
    override fun `$initMethods`() {
        this.facialRecognition = fun() {
            ...
            testFacialCo.getCertifyId(UTSJSONObject(Map<String, Any?>(utsArrayOf(
                ...
                console.log("res", res, " at pages/API/facial-recognition-verify/facial-recognition-verify.uvue:77");
            }
            ).`catch`(fun(err: Any?){
                console.error("error", err, " at pages/API/facial-recognition-verify/facial-recognition-verify.uvue:80");
            }
            );
        }
        ;
