...
open class GenPagesCSSFlexFlexBasis : BasePage {
        ...
        return createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("flex-grow" to "1"))), utsArrayOf(
            createElementVNode("view", null, utsArrayOf(
                ...
                createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("width" to "250px", "height" to "150px", "background-color" to "gray", "flex-direction" to "row"))), utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "common", "style" to normalizeStyle(utsMapOf("flex-basis" to "150px"))), utsArrayOf(
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("common" to padStyleMapOf(utsMapOf("width" to 50, "height" to 50, "backgroundColor" to "#FF0000", "justifyContent" to "center", "alignItems" to "center")));
            }
