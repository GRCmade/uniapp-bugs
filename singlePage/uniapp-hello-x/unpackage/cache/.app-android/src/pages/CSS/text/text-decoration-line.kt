    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("flex-grow" to "1"))), utsArrayOf(
            createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("height" to "250px", "background-color" to "gray", "justify-content" to "center", "align-items" to "center"))), utsArrayOf(
                createElementVNode("text", utsMapOf("class" to "common", "style" to normalizeStyle(utsMapOf("text-decoration-line" to "underline"))), "text-decoration-line: underline", 4),
                createElementVNode("text", utsMapOf("class" to "common", "style" to normalizeStyle(utsMapOf("text-decoration-line" to "line-through"))), "text-decoration-line: line-through", 4)
            ), 4)
        ), 4);
    }
    companion object {
