...
open class GenPagesCSSDisplayNone : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("class" to "page", "style" to normalizeStyle(utsMapOf("flex" to "1"))), utsArrayOf(
            createElementVNode("view", utsMapOf("class" to "head"), utsArrayOf(
                createElementVNode("text", utsMapOf("class" to "tip"), "下面有一个灰色区域，display默认值为none"),
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("display" to "none");
    }
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("page" to padStyleMapOf(utsMapOf("alignItems" to "center", "height" to "100%")), "head" to padStyleMapOf(utsMapOf("marginTop" to 10, "marginBottom" to 10, "alignItems" to "center")), "tip" to padStyleMapOf(utsMapOf("color" to "#FF0000")), "content" to padStyleMapOf(utsMapOf("borderWidth" to 5, "borderStyle" to "solid", "borderColor" to "#0000FF", "marginTop" to 50, "marginRight" to 0, "marginBottom" to 50, "marginLeft" to 0, "paddingTop" to 50, "paddingRight" to 50, "paddingBottom" to 50, "paddingLeft" to 50, "width" to 200, "height" to 200, "backgroundColor" to "#808080", "alignItems" to "center", "justifyContent" to "center")));
            }
