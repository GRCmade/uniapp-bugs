    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("flex-grow" to "1"))), utsArrayOf(
            createElementVNode("view", null, utsArrayOf(
                createElementVNode("text", null, "border-top: 5px dashed blue"),
                createElementVNode("view", utsMapOf("class" to "common", "style" to normalizeStyle(utsMapOf("border-top" to "5px dashed blue"))), null, 4)
            ))
        ), 4);
    }
    companion object {
