...
open class GenComponentsBooleanDataBooleanData : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("class" to "button-data-main uni-flex"), utsArrayOf(
            ...
            createVNode(_component_switch, utsMapOf("checked" to _ctx._checked, "onChange" to _ctx._change), null, 8, utsArrayOf(
                "checked",
                "onChange"
            ))
        ));
    ...
    companion object {
        ...
        var props = normalizePropsOptions(utsMapOf("title" to utsMapOf("type" to "String", "default" to ""), "defaultValue" to utsMapOf("type" to "Boolean", "default" to false)));
