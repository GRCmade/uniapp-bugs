...
open class GenComponentsApiSetTabbarApiSetTabbar : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("title" to "tababr", "hasSetTabBarBadge" to false, "hasShownTabBarRedDot" to false, "hasCustomedStyle" to false, "hasCustomedItem" to false, "hasHiddenTabBar" to false);
    }
