...
open class GenUniModulesUniUpgradeCenterAppComponentsUniUpgradeCenterAppUniUpgradeCenterApp : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return withDirectives(createElementVNode("view", utsMapOf("class" to "mask flex-center"), utsArrayOf(
    ...
    override fun `$initMethods`() {
        ...
        this.show = fun(shown: Boolean, localPackageInfo: UniUpgradeCenterResult?) {
            ...
            for(key in localPackageInfo){
                if (requiredKey.indexOf(key) != -1 && localPackageInfo[key] === null) {
                    console.error("\u53C2\u6570 " + key + " \u5FC5\u586B\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5", " at uni_modules/uni-upgrade-center-app/components/uni-upgrade-center-app/uni-upgrade-center-app.uvue:147");
        ...
        this.downloadPackage = fun() {
            ...
            , fail = fun(err){
                console.log("downloadFile err: ", err, " at uni_modules/uni-upgrade-center-app/components/uni-upgrade-center-app/uni-upgrade-center-app.uvue:251");
            }
            ));
            if (downloadTask !== null) {
        ...
        this.installPackage = fun() {
            ...
            uni_installApk(InstallApkOptions(filePath = this.tempFilePath, success = fun(_){
                console.log("installApk success", " at uni_modules/uni-upgrade-center-app/components/uni-upgrade-center-app/uni-upgrade-center-app.uvue:311");
                this.installing = false;
                this.installed = true;
            }
            , fail = fun(err){
                console.error("installApk fail", err, " at uni_modules/uni-upgrade-center-app/components/uni-upgrade-center-app/uni-upgrade-center-app.uvue:316");
                this.installing = false;
                this.installed = false;
