...
(function(vue) {
  ...
  function test() {
    formatAppLog("log", "at pages/index/index.vue:16", "test");
  }
  const _sfc_main$4 = {
    data() {
      return {
    ...
    onShow() {
      formatAppLog("log", "at pages/index/index.vue:36", "onShow");
      uni.setTabBarItem({
        index: 0,
        text: "xxx"
      });
    ...
    onHide() {
      formatAppLog("log", "at pages/index/index.vue:48", "onHide");
      setTimeout(() => {
        uni.setTabBarItem({
          index: 0,
          text: "首页"
    ...
    methods: {
      yuheClick() {
        plus.runtime.launchApplication({
          ...
          formatAppLog("log", "at pages/index/index.vue:61", JSON.stringify(e2));
        });
      },
      inputchange() {
        ...
        if (this.lastInputTime) {
          ...
          formatAppLog("log", "at pages/index/index.vue:69", interval);
      ...
      click() {
        uni.chooseImage({
          ...
          success: function(res) {
            formatAppLog("log", "at pages/index/index.vue:87", JSON.stringify(res.tempFilePaths));
          },
          fail(e2) {
            formatAppLog("log", "at pages/index/index.vue:90", e2);
          }
        });
      }
    }
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
      ...
      vue.createElementVNode("view", {
        class: "title",
        onClick: _cache[1] || (_cache[1] = (...args) => $options.yuheClick && $options.yuheClick(...args))
      }, " yuhe "),
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "/Users/gaoruicheng/Documents/HBuilderProjects/macbookpro/pages/index/index.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {};
    },
    onShow() {
      formatAppLog("log", "at pages/page/page.vue:15", "onShow-2");
    },
    methods: {}
  };
  ...
  const PagesPagePage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "/Users/gaoruicheng/Documents/HBuilderProjects/macbookpro/pages/page/page.vue"]]);
  const _sfc_main$2 = {};
  function _sfc_render$1(_ctx, _cache) {
    return null;
  }
  const PagesPagePage2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "/Users/gaoruicheng/Documents/HBuilderProjects/macbookpro/pages/page/page2.vue"]]);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/page/page", PagesPagePage);
  __definePage("pages/page/page2", PagesPagePage2);
  const _sfc_main$1 = {
    onLaunch: function() {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "/Users/gaoruicheng/Documents/HBuilderProjects/macbookpro/App.vue"]]);
  const _sfc_main = {};
  function _sfc_render(_ctx, _cache) {
    return " 11 ";
  }
  const componentVue = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/gaoruicheng/Documents/HBuilderProjects/macbookpro/pages/components/component.vue"]]);
  const pages = [
    {
  ...
  const S = true, b = "app", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.31.64"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"uniapp-test","spaceId":"mp-701e6f43-b3d1-467b-be68-d24d7eaaa29a","clientSecret":"SqnahZ3Al1OZGbajkDP+6Q==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let O = "";
  try {
    O = "__UNI__B04CDE1";
  } catch (e2) {
